...
from utils.pdf_bao_cao_xuat import tao_pdf_bao_cao_xuat
    ...
    with tab_xuat:
        ...
        if xem:
            ...
            if not ds:
                ...
                df["Đơn giá bán"] = df["Đơn giá bán"].apply(
                    lambda x: f"{x:,.0f}"
                )
                ...
                with c1:
                    st.download_button(
                        "📄 Xuất PDF",
                        data=pdf,
                        file_name="Bao_cao_xuat_hang.pdf",
                        mime="application/pdf",
                        use_container_width=True,
                        type="primary"
                    )
                ...
                with c2:
                    st.download_button(
                        "📊 Xuất Excel",
                        data=buffer,
                        file_name="Bao_cao_xuat_hang.xlsx",
                        mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
                        use_container_width=True,
                        type="primary"
                    )
